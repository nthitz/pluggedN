		...
		inlineImagesInterval = setInterval(function() {
		    ...
		    return $("#chat-messages .text a").each(function (e, t) {
		    	...
		    	if (t.href.match(/(\.png|\.gif|\.jpg|\.jpeg)$/i)) {
		            ...
		            return t.outerHTML = "<img class='closeImage' style='position: absolute; right: 0px; cursor: pointer;' src='http://i.imgur.com/JvlpEy9.png' data-src='" + t.href + "'' /><video class='plugEmbed' style='width: 100%'><source src='" + t.href + "' type='video/webm'></video>"
		        }
		    })
		},1e3)
	} else {
